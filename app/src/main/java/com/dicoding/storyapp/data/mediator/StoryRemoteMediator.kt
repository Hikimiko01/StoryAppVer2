    ...
    override suspend fun load(
        ...
        val page = when (loadType) {
            LoadType.REFRESH ->{
                ...
                remoteKeys?.nextKey?.minus(1) ?: com.dicoding.storyapp.data.mediator.StoryRemoteMediator.Companion.INITIAL_PAGE_INDEX
            }
            LoadType.PREPEND -> {
        ...
        try {
            ...
            val responseData = apiService.getStory(page, state.config.pageSize).story
